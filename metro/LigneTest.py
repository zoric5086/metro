class ClasseLigne0():
    ...
    liste_stations = []
    liste_stations.append((350, "SAINT DENIS PLEYEL Q1", 1, "H", 50))
    liste_stations.append((350, "SAINT DENIS PLEYEL Q2", 2, "B", 50))
    liste_stations.append((650, "MAIRIE DE SAINT-OUEN Q1", 1, "H", 50))
    liste_stations.append((650, "MAIRIE DE SAINT-OUEN Q2", 2, "B", 50))
    liste_stations.append((1025, "CLICHY SAINT-OUEN Q1", 1, "H", 50))
    liste_stations.append((1025, "CLICHY SAINT-OUEN Q2", 2, "B", 50))
    liste_stations.append((1445, "PORTE DE CLICHY Q1", 1, "H", 50))
    liste_stations.append((1445, "PORTE DE CLICHY Q2", 2, "B", 50))
    liste_stations.append((1695, "PONT CARDINET Q1", 1, "H", 50))
    liste_stations.append((1695, "PONT CARDINET Q2", 2, "B", 50))
    liste_stations.append((2125, "SAINT LAZARE Q1", 1, "H", 50))
    liste_stations.append((2125, "SAINT LAZARE Q2", 2, "B", 50))
    liste_stations.append((2395, "MADELEINE Q1", 1, "H", 50))
    liste_stations.append((2395, "MADELEINE Q2", 2, "B", 50))
    liste_stations.append((3325, "PYRAMIDES Q1", 1, "H", 50))
    liste_stations.append((3325, "PYRAMIDES Q2", 2, "B", 50))
    liste_stations.append((3885, "CHATELET Q1", 1, "H", 50))
    liste_stations.append((3885, "CHATELET Q2", 2, "B", 50))
    liste_stations.append((4545, "GARE DE LYON Q1", 1.5, "", 50))
    liste_stations.append((5005, "BERCY Q1", 1, "H", 50))
    liste_stations.append((5005, "BERCY Q2", 2, "B", 50))
    liste_stations.append((5565, "COUR ST EMILLION Q1", 1, "H", 50))
    liste_stations.append((5565, "COUR ST EMILLION Q2", 2, "B", 50))
    liste_stations.append((6144, "BIBLIOTHEQUE FRANCOIS MITTERRAND Q1", 1, "H", 50))
    liste_stations.append((6144, "BIBLIOTHEQUE FRANCOIS MITTERRAND Q2", 2, "B", 50))
    liste_stations.append((6539, "OLYMPIADES Q1", 1, "H", 50))
    liste_stations.append((6539, "OLYMPIADES Q2", 2, "B", 50))
    liste_stations.append((6939, "MAISON BLANCHE Q1", 1, "H", 50))
    liste_stations.append((6939, "MAISON BLANCHE Q2", 2, "B", 50))
    liste_stations.append((7339, "HOPITAL BICETRE Q1", 1, "H", 50))
    liste_stations.append((7339, "HOPITAL BICETRE Q2", 2, "B", 50))
    liste_stations.append((7739, "VILLEJUIF GUSTAVE ROUSSY Q1", 1, "H", 50))
    liste_stations.append((7739, "VILLEJUIF GUSTAVE ROUSSY Q2", 2, "B", 50))
    liste_stations.append((8119, "L'HAI LES ROSES Q1", 1, "H", 50))
    liste_stations.append((8119, "L'HAI LES ROSES Q2", 2, "B", 50))
    liste_stations.append((8319, "CHEVILLY LARUE Q1", 1, "H", 50))
    liste_stations.append((8319, "CHEVILLY LARUE Q2", 2, "B", 50))
    liste_stations.append((8939, "THIAIS ORLY Q1", 1, "H", 50))
    liste_stations.append((8939, "THIAIS ORLY Q2", 2, "B", 50))
    liste_stations.append((9339, "AEROPORT D'ORLY Q1", 1, "H", 50))
    liste_stations.append((9339, "AEROPORT D'ORLY Q2", 2, "B", 50))
    ...
    liste_metro.append(("1", 8800, 2, 2, 1, "#EB0004"))
    liste_metro.append(("2",200, 2, 2, 1, "#EB0004"))
    liste_metro.append(("3",700,  2, 2, 1, "#EB0004"))
    liste_metro.append(("4",1000, 2, 2, 1, "#EB0004"))
    liste_metro.append(("5",1300,  2, 2, 1, "#EB0004"))
    liste_metro.append(("6",1600, 2, 2, 1, "#EB0004"))
    liste_metro.append(("7",1900, 2,2, 1, "#EB0004"))
    liste_metro.append(("8",2200,2, 2, 1, "#EB0004"))
    liste_metro.append(("9",2500,  2, 2, 1, "#EB0004"))
    liste_metro.append(("10",2800, 2, 2, 1, "#EB0004"))
    liste_metro.append(("11",3100,  2,2, 1, "#EB0004"))
    liste_metro.append(("12",3400,2, 2 , 1, "#EB0004"))
    liste_metro.append(("13",3700,  2, 2 , 1, "#EB0004"))
    liste_metro.append(("14",4000,2, 2, 1, "#EB0004"))
    liste_metro.append(("15",4300,  2, 2, 1, "#EB0004"))
    liste_metro.append(("16",4600, 2, 2, 1, "#EB0004"))
    liste_metro.append(("17", 400, 2, 2, 1, "#EB0004"))
    liste_metro.append(("18",400,  -2, 1, 1,"#EB0004"))
    liste_metro.append(("19", 700, -2, 1, 1, "#EB0004"))
    liste_metro.append(("20",1000,  -2, 1, 1, "#EB0004"))
    liste_metro.append(("21", 1300, -2, 1, 1, "#EB0004"))
    liste_metro.append(("22",1600,  -2, 1, 1, "#EB0004"))
    liste_metro.append(("23", 1900, -2, 1, 1,"#EB0004" ))
    liste_metro.append(("24",2200,  -2, 1, 1,"#EB0004" ))
    liste_metro.append(("25", 2500, -2, 1 , 1,"#EB0004" ))
    liste_metro.append(("26",2800,  -2, 1, 1,"#EB0004" ))
    liste_metro.append(("27", 3100, -2, 1, 1,"#EB0004" ))
    liste_metro.append(("28",3400,  -2, 1, 1,"#EB0004" ))
    liste_metro.append(("29", 3700, -2, 1, 1,"#EB0004" ))
    liste_metro.append(("30",4000,  -2, 1, 1,"#EB0004" ))
    liste_metro.append(("31", 4300, -2, 1, 1,"#EB0004" ))
    liste_metro.append(("32", 4600, -2, 1, 1,"#EB0004" ))
    liste_metro.append(("33",4900,  -2, 1, 1,"#EB0004" ))
    liste_metro.append(("34", 4900, 2, 2, 1,"#EB0004" ))
    liste_metro.append(("35",5200,  -2, 1, 1,"#EB0004" ))
    liste_metro.append(("36", 5200, 2, 2, 1,"#EB0004" ))
    liste_metro.append(("37",5500, -2, 1, 1,"#EB0004" ))
    liste_metro.append(("38",5500,  2, 2, 1,"#EB0004" ))
    liste_metro.append(("39", 5800, -2, 1, 1,"#EB0004" ))
    liste_metro.append(("40",5800,  2, 2, 1,"#EB0004" ))
    liste_metro.append(("41", 6100, -2, 1, 1,"#EB0004" ))
    liste_metro.append(("42  ",6100, 2, 2, 1,"#EB0004" ))
    liste_metro.append(("43",6400,  -2, 1, 1,"#EB0004" ))
    liste_metro.append(("44", 6400, 2, 2, 1,"#EB0004" ))
    liste_metro.append(("45",6700,  -2, 1, 1,"#EB0004" ))
    liste_metro.append(("46", 6700, 2, 2, 1,"#EB0004" ))
    liste_metro.append(("47  ",7000, -2, 1, 1,"#EB0004" ))
    liste_metro.append(("48",7000,  2, 2, 1,"#EB0004" ))
    liste_metro.append(("49  ",7300, -2, 1, 1,"#EB0004" ))
    liste_metro.append(("50",7300,  2, 2, 1,"#EB0004" ))
    liste_metro.append(("51",7600,  -2, 1, 1,"#EB0004" ))
    liste_metro.append(("52",7600,  2, 2, 1,"#EB0004" ))
    liste_metro.append(("53", 7900, -2, 1, 1,"#EB0004" ))
    liste_metro.append(("54",7900,  2, 2 , 1,"#EB0004" ))
    liste_metro.append(("55", 8200, -2, 1, 1,"#EB0004" ))
    liste_metro.append(("56 ",8200, 2, 2, 1,"#EB0004" ))
    liste_metro.append(("57",8500,  -2, 1, 1,"#EB0004" ))
    liste_metro.append(("58", 8500, 2, 2, 1,"#EB0004" ))
    liste_metro.append(("59",8800,  -2, 1, 1,"#EB0004" ))
    liste_metro.append(("61", 9100, 2, 2, 1,"#EB0004" ))
    liste_metro.append(("62",9100, -2, 1, 1,"#EB0004" ))
    liste_metro.append(("63",9400,  2, 2, 1,"#EB0004" ))
    liste_metro.append(("64",9400,  -2, 1, 1,"#EB0004" ))
    liste_metro.append(("65",9700,  2, 2, 0,"#EB0004" ))
    liste_metro.append(("66",9700,  -2, 1, 0,"#EB0004" ))


    liste_lignes = []
    # Offset, x debut, x fin, couleur, largeur
    liste_lignes.append((1,250, 6990, "#EBEBEB", 3))
    liste_lignes.append((2,250, 6990,  "#EBEBEB", 3))
    liste_lignes.append((1,7200, 10000,  "#EBEBEB", 3))
    liste_lignes.append((2,7200, 10000,  "#EBEBEB", 3))


    liste_depot_eguillage = []
    # eguillage depot
    #x1, offset 1, x2, offset 2, 0=inactif / 1=> / 2=<, Nom, Couleur
    ...
    liste_depot_eguillage.append((1065, 5, 1095, 5, 0, "Eg D3","#CCCCCC"))
    liste_depot_eguillage.append((1065, 6, 1095, 4, 0, "Eg D4","#CCCCCC"))
    liste_depot_eguillage.append((1095, 5, 1125, 3, 0, "Eg D5","#CCCCCC"))
    liste_depot_eguillage.append((1095, 6, 1125, 6, 0, "Eg D6","#CCCCCC"))
    liste_depot_eguillage.append((1125, 7, 1155, 7, 0, "Eg D7","#CCCCCC"))
    liste_depot_eguillage.append((1155, 8, 1185, 8, 0, "Eg D7","#CCCCCC"))
    liste_depot_eguillage.append((7030, 2, 7060, 3, 0, "Eg OLYMPIADES","#CCCCCC"))
    ...
    liste_depot_ligne.append((3, 1125, 1395,"#CCCCCC", 2))
    liste_depot_ligne.append((4, 945, 1395,"#CCCCCC", 2))
    liste_depot_ligne.append((5, 975, 1395,"#CCCCCC", 2))
    liste_depot_ligne.append((6, 1125, 1395,"#CCCCCC", 2))
    liste_depot_ligne.append((7, 1155, 1395,"#CCCCCC", 2))
    liste_depot_ligne.append((8, 1185, 1395,"#CCCCCC", 2))
    liste_depot_ligne.append((3, 7090, 7150,"#CCCCCC", 2))
    ...
    liste_feu_traffic.append(("314", 9760, 1, "H", 1))
    # feu depot
    liste_feu_traffic.append(("314", 985, 5, "H", 1))
    liste_feu_traffic.append(("314", 985, 6, "H", 1))
    liste_feu_traffic.append(("314", 1100, 7, "B", 1))
    liste_feu_traffic.append(("314", 1100, 8, "B", 1))
