class ClasseLigne14():
    ...
    liste_eguillages.append((3975, 130,3945, 100, 0, "Eg chatelet1"))
    liste_eguillages.append((4620, 100,4650, 130, 0, "Eg gare de lyon1"))
    liste_eguillages.append((6200, 100, 6230, 130, 0, "Eg BIBLIOTHEQUE FRANCOIS MITTERRAND1"))
    liste_eguillages.append(( 6620, 130,6650, 100, 0, "Eg OLYMPIADES1"))
    liste_eguillages.append((6620, 100, 6650, 130, 0, "Eg OLYMPIADES2"))
    liste_eguillages.append((6620, 100, 6650, 130, 0, "Eg OLYMPIADES1"))
    liste_eguillages.append(( 6999, 100,7029, 130, 0, "Eg MAISON BLANCHE1"))
    liste_eguillages.append(( 7820, 100,7850, 130, 0, "Eg VILLEJUIF GUSTAVE ROUSSY1"))
    liste_eguillages.append(( 9010, 100,9040, 130, 0, "Eg THAIS ORLY1"))
    liste_eguillages.append(( 9440, 130,9470, 100, 1, "Eg AEROPORT D'ORLY1"))
    liste_eguillages.append((9440, 100, 9470, 130, 0, "Eg AEROPORT D'ORLY2"))
    liste_eguillages.append(( 9620, 130,9650, 100, 0, "Eg AEROPORT D'ORLY3"))
    liste_eguillages.append((9620, 100, 9650, 130, 0, "Eg AEROPORT D'ORLY4"))
    liste_terminus = []
    liste_terminus.append((200, 100, "SAINT DENIS PLEYEL1",1))
    liste_terminus.append((200, 130, "SAINT DENIS PLEYEL2",1))
    liste_terminus.append((470, 100, "MAIRIE DE SAINT OUEN1", 0))
    liste_terminus.append((470, 130, "MAIRIE DE SAINT OUEN2", 0))
    liste_terminus.append((1045, 190, "D1", 0))
    liste_terminus.append((1045, 220, "D2", 0))
    liste_terminus.append((1045, 250, "D3", 0))
    liste_terminus.append((1045, 280, "D4", 0))
    liste_terminus.append((1045, 310, "D5", 0))
    liste_terminus.append((1310, 100, "PORTE DE CLICHY1", 0))
    liste_terminus.append((1310, 130, "PORTE DE CLICHY2", 0))
    liste_terminus.append((1970, 100, "SAINT LAZARE", 0))
    liste_terminus.append((2290, 100, "MADELEINE1", 0))
    liste_terminus.append((2290, 130, "MADELEINE1", 0))
    liste_terminus.append((4035, 130, "CHATELET", 0))
    liste_terminus.append((4710, 130, "GARE DE LYON", 0))
    liste_terminus.append((6290, 130, "BIBLIOTHEQUE FRANCOIS MITTERRAND1", 0))
    liste_terminus.append((6710, 100, "OLYMPIADES1", 0))
    liste_terminus.append((6710, 130, "OLYMPIADES2", 0))
    liste_terminus.append((7089, 100, "MAISON BLANCHE1", 0))
    liste_terminus.append((7949, 130, "VILLEJUIF GUSTAVE ROUSSY1", 0))
    liste_terminus.append((1000, 130, "THAIS ORLY1", 0))
    liste_terminus.append((9530, 100, "AEROPORT D'ORLY1", 1))
    liste_terminus.append((9530, 130, "AEROPORT D'ORLY2", 1))
    ...
    liste_metro.append(("65",9700,  0.30, 80, 0,"#EB0004" ))
    liste_metro.append(("66",9700,  -0.30, 50, 0,"#EB0004" ))
    ...
    liste_eguillages.append((6720, 130, 6750, 160, 0, "Eg OLYMPIADES","#CCCCCC"))
    ...
    liste_depot_ligne.append((6750, 160, 6810, 160, "#EBEBEB", 4))
