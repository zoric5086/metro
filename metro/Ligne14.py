class ClasseLigne14():
    ...
    liste_stations.append((350, "SAINT DENIS PLEYEL Q2", 2, "B", 1520))
    liste_stations.append((650, "MAIRIE DE SAINT-OUEN Q1", 1, "H", 560))
    liste_stations.append((650, "MAIRIE DE SAINT-OUEN Q2", 2, "B", 560))
    liste_stations.append((950, "CLICHY SAINT-OUEN Q1", 1, "H", 480))
    liste_stations.append((950, "CLICHY SAINT-OUEN Q2", 2, "B", 480))
    liste_stations.append((1250, "PORTE DE CLICHY Q1", 1, "H", 500))
    liste_stations.append((1250, "PORTE DE CLICHY Q2", 2, "B", 500))
    liste_stations.append((1550, "PONT CARDINET Q1", 1, "H", 500))
    liste_stations.append((1550, "PONT CARDINET Q2", 2, "B", 500))
    liste_stations.append((1850, "SAINT LAZARE Q1", 1, "H", 660))
    liste_stations.append((1850, "SAINT LAZARE Q2", 2, "B", 660))
    liste_stations.append((2150, "MADELEINE Q1", 1, "H", 660))
    liste_stations.append((2150, "MADELEINE Q2", 2, "B", 660))
    liste_stations.append((2450, "PYRAMIDES Q1", 1, "H", 600))
    liste_stations.append((2450, "PYRAMIDES Q2", 2, "B", 600))
    liste_stations.append((2750, "CHATELET Q1", 1, "H", 700))
    liste_stations.append((2750, "CHATELET Q2", 2, "B", 700))
    liste_stations.append((3150, "GARE DE LYON Q1", 1.5, "", 700))
    liste_stations.append((3450, "BERCY Q1", 1, "H", 560))
    liste_stations.append((3450, "BERCY Q2", 2, "B", 560))
    liste_stations.append((3750, "COUR ST EMILLION Q1", 1, "H", 500))
    liste_stations.append((3750, "COUR ST EMILLION Q2", 2, "B", 500))
    liste_stations.append((4050, "BIBLIOTHEQUE FRANCOIS MITTERRAND Q1", 1, "H", 600))
    liste_stations.append((4050, "BIBLIOTHEQUE FRANCOIS MITTERRAND Q2", 2, "B", 600))
    liste_stations.append((4350, "OLYMPIADES Q1", 1, "H", 560))
    liste_stations.append((4350, "OLYMPIADES Q2", 2, "B", 560))
    liste_stations.append((4650, "MAISON BLANCHE Q1", 1, "H", 560))
    liste_stations.append((4650, "MAISON BLANCHE Q2", 2, "B", 560))
    liste_stations.append((4950, "HOPITAL BICETRE Q1", 1, "H", 700))
    liste_stations.append((4950, "HOPITAL BICETRE Q2", 2, "B", 700))
    liste_stations.append((5250, "VILLEJUIF GUSTAVE ROUSSY Q1", 1, "H", 560))
    liste_stations.append((5250, "VILLEJUIF GUSTAVE ROUSSY Q2", 2, "B", 560))
    liste_stations.append((5550, "L'HAI LES ROSES Q1", 1, "H", 700))
    liste_stations.append((5550, "L'HAI LES ROSES Q2", 2, "B", 700))
    liste_stations.append((5850, "CHEVILLY LARUE Q1", 1, "H", 560))
    liste_stations.append((5850, "CHEVILLY LARUE Q2", 2, "B", 560))
    liste_stations.append((6150, "THIAIS ORLY Q1", 1, "H", 560))
    liste_stations.append((6150, "THIAIS ORLY Q2", 2, "B", 560))
    liste_stations.append((6550, "AÉROPORT D'ORLY Q1", 1, "H", 1520))
    liste_stations.append((6550, "AÉROPORT D'ORLY Q2", 2, "B", 500))
    ...
    liste_eguillages.append((1180, 2,1210, 1, 0, "Eg PORTE DE CLICHY1","#EBEBEB"))
    liste_eguillages.append((1180, 1, 1210, 2, 0, "Eg PORTE DE CLICHY2","#EBEBEB"))
    ...
    liste_metro.append(("1", 6600, 0, 1, 1, "#EB0004"))
    liste_metro.append(("2", 30, 0.05, 2, 0, "#EB0004"))
    liste_metro.append(("3",700,  0.05, 2, 1, "#EB0004"))
    liste_metro.append(("4",1000, 0.05, 2, 1, "#EB0004"))
    liste_metro.append(("5",1300,  0.05, 2, 1, "#EB0004"))
    liste_metro.append(("6",1600, 0.05, 2, 1, "#EB0004"))
    liste_metro.append(("7",1900, 0.05,2, 1, "#EB0004"))
    liste_metro.append(("8",2200, 0.05, 2, 1, "#EB0004"))
    liste_metro.append(("9",2500,  0.05,2 , 1, "#EB0004"))
    liste_metro.append(("10",2800, 0.05, 2, 1, "#EB0004"))
    liste_metro.append(("11",3100,  0.05,2, 1, "#EB0004"))
    liste_metro.append(("12",3400, 0.05, 2 , 1, "#EB0004"))
    liste_metro.append(("13",3700,  0.05, 2 , 1, "#EB0004"))
    liste_metro.append(("14",4000, 0.05, 2, 1, "#EB0004"))
    liste_metro.append(("15",4300,  0.05, 2, 1, "#EB0004"))
    liste_metro.append(("16",4600, 0.05, 2, 1, "#EB0004"))
    liste_metro.append(("17", 400, 0.05, 2, 1, "#EB0004"))
    liste_metro.append(("18",400,  -0.05, 1, 1,"#EB0004"))
    liste_metro.append(("19", 700, -0.05, 1, 1, "#EB0004"))
    liste_metro.append(("20",1000,  -0.05, 1, 1, "#EB0004"))
    liste_metro.append(("21", 1300, -0.05, 1, 1, "#EB0004"))
    liste_metro.append(("22",1600,  -0.05, 1, 1, "#EB0004"))
    liste_metro.append(("23", 1900, -0.05, 1, 1,"#EB0004" ))
    liste_metro.append(("24",2200,  -0.05, 1, 1,"#EB0004" ))
    liste_metro.append(("25", 2500, -0.05, 1 , 1,"#EB0004" ))
    liste_metro.append(("26",2800,  -0.05, 1, 1,"#EB0004" ))
    liste_metro.append(("27", 3100, -0.05, 1, 1,"#EB0004" ))
    liste_metro.append(("28",3400,  -0.05, 1, 1,"#EB0004" ))
    liste_metro.append(("29", 3700, -0.05, 1, 1,"#EB0004" ))
    liste_metro.append(("30",4000,  -0.05, 1, 1,"#EB0004" ))
    liste_metro.append(("31", 4300, -0.05, 1, 1,"#EB0004" ))
    liste_metro.append(("32", 4600, -0.05, 1, +1,"#EB0004" ))
    liste_metro.append(("33",4900,  -0.05, 1, 1,"#EB0004" ))
    liste_metro.append(("34", 4900, 0.05, 2, 1,"#EB0004" ))
    liste_metro.append(("35",5200,  -0.05, 1, 1,"#EB0004" ))
    liste_metro.append(("36", 5200, 0.05, 2, 1,"#EB0004" ))
    liste_metro.append(("37",5500, -0.05, 1, 1,"#EB0004" ))
    liste_metro.append(("38",5500,  0.05, 2, 1,"#EB0004" ))
    liste_metro.append(("39", 5800, -0.05, 1, 1,"#EB0004" ))
    liste_metro.append(("40",5800,  0.05, 2, 1,"#EB0004" ))
    liste_metro.append(("41", 6100, -0.05, 1, 1,"#EB0004" ))
    liste_metro.append(("42  ",6100, 0.05, 2, 1,"#EB0004" ))
    liste_metro.append(("43",6400,  -0.05, 1, 1,"#EB0004" ))
    liste_metro.append(("44", 6400, 0.05, 2, 1,"#EB0004" ))
